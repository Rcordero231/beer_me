...
function pageLoader(){
    ...
    // Add click listeners to the bubbles to show even propagation
    ...
    bubbles[2].addEventListener('click', e =>{
        console.log('You clicked inner... propagated from:', e.target.id)
        e.stopPropagation();
})
}
...
// Function to get the Beer ID whent the drag starts
function dragBeer(e){
    console.log('Dragging bear...')
    e.dataTransfer.setData('text', e.target.id);
}

// Function to handle the drop
function handleDrop(e){
    console.log('Dropppingbeer...')
